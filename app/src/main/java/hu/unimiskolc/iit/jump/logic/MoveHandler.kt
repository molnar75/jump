...
class MoveHandler {
    ...
    fun updatePlayerPosition(dummyGame: DummyGame) {
        ...
        when(state) {
            hu.unimiskolc.iit.jump.PlayerState.JUMP -> {
            ...
            hu.unimiskolc.iit.jump.PlayerState.LEFT -> {
            ...
            hu.unimiskolc.iit.jump.PlayerState.RIGHT -> {
            ...
            hu.unimiskolc.iit.jump.PlayerState.FALL -> {
                if (position.y > -screenHeight) {
                    updateSprite(gameItem, 0f, -1f)
                }
            }
            hu.unimiskolc.iit.jump.PlayerState.FALL_LEFT -> {
                if (position.x > -screenWidth) {
                    gameItem.currSprite = leftMoveSpriteIndex
            ...
            hu.unimiskolc.iit.jump.PlayerState.FALL_RIGHT -> {
                if (position.x < (screenWidth - gameItemTextureWidth)) {
                    gameItem.currSprite = rightMoveSpriteIndex
            ...
            hu.unimiskolc.iit.jump.PlayerState.WAIT -> {
